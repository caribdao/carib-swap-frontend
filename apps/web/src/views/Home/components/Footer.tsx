...
const ImageBox: React.FC = () => {
  return (
    <ImageWrapper>
      <Image className="pancake" src="images/caribswap/discord_icon.png" alt="discord" />
      <Image className="rock" src={`${ASSET_CDN}/web/landing/cta-rock.png`} alt="rock" />
      <Image className="big-pancake" src="images/caribswap/discord_icon.png" alt="big_discord" />
